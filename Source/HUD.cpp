    ...
    :UIScreen(game, fontName)
{
    ...
    mLevelName = AddText("Fase 1", glm::vec2(mGame->GetWindowWidth() - (CCHAR_WIDTH * 6 + WORD_OFFSET) + CCHAR_WIDTH, HUD_POS_Y), glm::vec2(CCHAR_WIDTH * 3, WORD_HEIGHT), POINT_SIZE, 1024);
}
